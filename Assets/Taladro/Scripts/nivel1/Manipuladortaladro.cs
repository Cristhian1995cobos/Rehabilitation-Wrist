...
public class Manipuladortaladro : MonoBehaviour {
    ...
    void Start()
    {
        FalconUnity.setForceField(falcon_num, new Vector3(0, 0, -9));
    contador.taladro = 0;
    contador.aciertos = 0;
    ...
    void Update()
    {
        ...
        if (contador.ganador_taladro == 0)
        {
            ...
            godObject1.position = godObject.position;
